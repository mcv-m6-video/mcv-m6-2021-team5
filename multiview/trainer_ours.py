...
from datasets import TripletMNIST, TripletVeriDataset, aicityTriplet
...
if (__name__ == '__main__'):
	...
	training_data = aicityTriplet(filenames_txt = "../datasets/train.txt", image_dir = "../datasets/cars/S0104", transform = train_transform)
	validation_data = aicityTriplet(filenames_txt = "../datasets/test.txt", image_dir = "../datasets/cars/S03", transform = test_transform)
