...
for seq in seqs: 
    ...
    tracks_dict[seq] = track_kalman(bb_det, bb_gt, max_age=10, min_hits=4, iou_threshold=0.1, score_threshold=0.7, seq=seq, extract_descriptors=True, start_frame=start)
    ...
    with open('datasets/tracks/' + dir_tracks +  '/tracks_seq_'+seq+'_070.pkl','wb') as f:
