...
def plot_detections(detection_list, gt_list=None, show=True):
    """
    ...
    img_path = './datasets/aicity/AICity_data/train/S03/c010/frames/frame_' + str(detection_list[0].frame).zfill(4) + '.png'
